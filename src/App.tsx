        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-4">
              ...
              <Link to="/report" className="bg-blue-700 hover:bg-blue-600 px-4 py-2 rounded-md">Report Item</Link>
            </div>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link to="/report" className="block bg-blue-700 hover:bg-blue-600 px-4 py-2 rounded-md">Report Item</Link>
            </div>
          </div>
        )}
      </div>
